...
/**
 * Minimum balance (in sub-paise) below which a debt is considered fully closed.
 * 0.005 = half a paise, sufficient to absorb floating-point rounding in monthly
 * interest and principal calculations without masking a genuinely open balance.
 */
 ...
 * would never reduce.
 * Returns an empty array when emiAmount <= 0 or interestRate < 0.
 */
